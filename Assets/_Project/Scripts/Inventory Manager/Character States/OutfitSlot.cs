...
{
    public class OutfitSlot : Slot, IDropHandler, IPointerClickHandler
    {
        public static Action<GameItemSO> OnUnequipOutfit;
        ...
        public override void EmptySlot()
        {
            ...
            OnUnequipOutfit?.Invoke(currentInventoryItem.gameItem);
            base.EmptySlot();
        }
