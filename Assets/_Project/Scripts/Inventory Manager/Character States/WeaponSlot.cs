...
{
    public class WeaponSlot : Slot, IDropHandler, IPointerClickHandler
    {
        public static Action<GameItemSO> OnUnequipWeapon;
        ...
        public override void EmptySlot()
        {
            ...
            OnUnequipWeapon?.Invoke(currentInventoryItem.gameItem);
            base.EmptySlot();
        }
